...
% % TODO skills - talks - experience - education - interests
...
\cvitem{--}{Creating heterogeneous distributed applications using REST, Web Services and queues.}
\cvitem{--}{Managing AWS infrastructure with Terraform.}
\cvitem{--}{Development and testing of microservice-based solutions.}
\cvitem{--}{Focus on Test Driven Development.}
\cvitem{--}{Implementing system security, and a workable knowledge of cryptography.}
